...
- (void)awakeFromNib {
    ...
    [_pageControl setTintColor: GRAY_COLOR] ;
...
- (void)setMaxPageControlNumber:(NSUInteger)maxPageControlNumber {
    _pageControl.numberOfPages = VALCond(_arrBanner.count > maxPageControlNumber,
                                         maxPageControlNumber, _arrBanner.count);
    [_clvBanner reloadData];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_arrBanner.count >0) {
        ...
        cell.imgBanner.backgroundColor = GRAY_COLOR;
